...
def create_shot_map_team(df,
    ...
    plt.figtext(0.13,
                -0.03,
                f'Made with footsbviz. Data provided by StatsBomb. Excluding penalties.\n',
                fontstyle='italic',
                fontsize=15, 
...
def create_xg_race_chart(df,
    ...
    plt.figtext(0.04,
                -0.07,
                f'Made with footsbviz. Data provided by StatsBomb.\n',
                fontstyle='italic',
                fontsize=15, 
                fontfamily=main_font,
                color=text_colour
...
def create_obv_teams_bar_chart(df,
    ...
    plt.figtext(0.045,
                -0.04,
                f'Made with footsbviz. OBV is a model that assigns a value to every action on the football pitch.\nData provided by StatsBomb.\n',
                fontstyle='italic',
                fontsize=15, 
                fontfamily=main_font,
                color=text_colour
...
def create_obv_players_bar_chart(df,
    ...
    plt.figtext(0.045,
                -0.04,
                f'Made with footsbviz. Data provided by StatsBomb. OBV is a model that assigns a value to every action on the football pitch.\nOBV calculated for\n{lst_actions} events.\nEach player has played a minimum of {mins_limit} minutes and their OBV values are standardised per 90 minutes.\n',
                fontstyle='italic',
                fontsize=15, 
                fontfamily=main_font,
                color=text_colour
...
def create_xg_diff_bar_chart(df,
    ...
    plt.figtext(0.045,
                -0.02,
                f'Made with footsbviz. Data provided by StatsBomb. A team\'s xG difference is their xG minus xG against. Penalties excluded.\nxG difference is standardised per 90 minutes.',
                fontstyle='italic',
                fontsize=15, 
                fontfamily=main_font,
                color=text_colour
...
def create_xg_bar_chart(df,
    ...
    plt.figtext(0.045,
                -0.04,
                f'Made with footsbviz. Data provided by StatsBomb. Penalties excluded.\n',
                fontstyle='italic',
                fontsize=15, 
                fontfamily=main_font,
                color=text_colour
